...
#                reward = np.arccos(dynamics.m[2])/np.pi
        ...
        if total_reward > high_reward:
            s.save_episode(episode, t, m, h, "fig_actorcritic")
        ...
        s.save_reward_history(reward_history, "fig_actorcritic")

        s.save_loss_history(loss_v_history, "fig_actorcritic")
        s.save_loss_pi_history(loss_pi_history, "fig_actorcritic")
