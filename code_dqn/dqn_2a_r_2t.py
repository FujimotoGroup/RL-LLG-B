...
#                    reward = 1
                ...
                loss = agent.update(old_m, old_action, reward, dynamics.m, done)
        ...
        if total_reward > high_reward:
            s.save_episode(episode, t, m, h, "fig_dqn5")
        ...
        if episode > sync_interval:
            ...
            s.save_loss_history(loss_history, "fig_dqn5")

        s.save_reward_history(reward_history, "fig_dqn5")
